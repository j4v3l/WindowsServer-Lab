...
```
Demo/
├── README.md                          # Demo environments overview and comparison
├── Asgard/                           # This directory - Norse mythology enterprise demo
│   ├── README.md                      # This file - Asgard demo overview and features
...
│   │   └── Deploy-AdvancedSecurityDemo.ps1  # Asgard security features demo
│   ├── Guides/                        # Asgard quick-start and user guides
│   │   ├── QUICK_START_ASGARD.md      # Asgard 3-step deployment guide
│   │   ├── ASGARD_NETWORK_SHARE_SETUP.md  # Network shares setup guide
...
│       └── NETWORK_SHARE_SETUP_GUIDE.md   # Network configuration guide
└── Olympus/                          # Greek mythology enterprise demo
    ...
    ├── Scripts/                       # Olympus deployment and management scripts
    │   ├── Deploy-OlympusLab.ps1      # Main Olympus deployment script
    │   └── Deploy-AdvancedSecurityDemo.ps1  # Olympus security features demo
    ├── Guides/                        # Olympus quick-start and user guides
    │   ├── QUICK_START_OLYMPUS.md     # Olympus 3-step deployment guide
    │   └── OLYMPUS_NETWORK_SHARE_SETUP.md  # Network shares setup guide
    └── Documentation/                 # Olympus technical documentation
        ├── DEMO_SETUP_GUIDE.md        # Olympus complete setup guide
        └── HARDWARE_PERFORMANCE_GUIDE.md  # Hardware optimization guide
```
...
- Run: `Demo/Asgard/Scripts/Deploy-AsgardLab.ps1`
- Time: 30-60 minutes
...
- ✅ File Shares & Permissions ([Asgard Setup Guide](Guides/ASGARD_NETWORK_SHARE_SETUP.md))
